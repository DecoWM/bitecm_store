...
// $('#list-equipos .producto').mouseover(function() {

// 	/* Act on the event */
// 	var data-equipo = $(this).attr('data', 'data-equipo');
	
// 	console.log(data-equipo);

// 	 $('.checkbox-compare').change(function(){
// 	    if($(this).is(":checked")) {
// 	        $(this).closest('.producto').addClass("active-comparar");
// 	        console.log('hola')
// 	    } else {
// 	        $(this).closest('.producto').removeClass("active-comparar");
// 	        console.log('chau')
// 	    }
// 	});
// });
...
$('.btn-acordion').click(function(event) {
  ...
  // $(this).closest('.content-catalogo').attr('id');
  
  // var $content-id = $(this).closest('.content-catalogo').attr('id');

  // $('#'+$content-id+'' .select-item).addClass('active');

  // $(this).closest('.title-select').next().removeClass('active');
...
},{"./vendor/slick.js":16,"bootstrap":1,"jquery":14}],16:[function(require,module,exports){
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
/ __| | |/ __| |/ /  | / __|
