          ...
          <div class="col-xs-12 col-sm-10 col-sm-offset-1">
            <div id="form-cliente">
              <div id="form-vue-validator">
                <form action="{{route('store_order')}}" method="POST" ref="orderform">
                  {{ csrf_field() }}
                  ...
                  <div class="btn-detalle">
                    <div class="row">
                      <div class="col-xs-12 col-sm-8 col-sm-push-2">
                        ...
                        <button :click="validateInfoCliente($event)" id="submitOrder" type="submit" class="btn btn-default comprar" data-sub="0">continuar</button>
                      </div>
                    </div>
                  </div>
                </form>
