                ...
                <form @submit.prevent="validateInfoCliente" action="{{route('store_order')}}" method="POST" ref="orderform">
                  ...
                  <div class="section-form">
                    <div class="form-group">
                      ...
                      <input id="first_name" type="text" name="first_name" v-model="first_name" v-init:first_name="{{array_get($order_detail,'first_name','')}}" v-validate="'required|alpha_spaces|max:100'" maxlength="100" :class="{'input': true, 'is-danger': errors.has('first_name')}"><i v-cloak v-show="errors.has('first_name')" class="fa fa-warning"></i>
                    ...
                    <div class="form-group">
                      ...
                      <input id="last_name" type="text" name="last_name" v-model="last_name" v-init:last_name="{{array_get($order_detail,'last_name','')}}" v-validate="'required|alpha_spaces|max:100'" maxlength="100" :class="{'input': true, 'is-danger': errors.has('last_name')}"><i v-cloak v-show="errors.has('last_name')" class="fa fa-warning"></i>
                    ...
                    <div class="form-group form-select">
                      ...
                      <select id="document_type" name="document_type" v-model="select_document" v-init:select_document="{{array_get($order_detail,'idtype_id','')}}" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('document_type') }"><i v-cloak v-show="errors.has('document_type')" class="fa fa-warning"></i>
                    ...
                    <div class="form-group">
                      ...
                      <input id="document_number" type="text" name="document_number"  v-bind:maxlength="select_document == 1 ? '8' : '12'" v-model="number_document" v-init:number_document="{{array_get($order_detail,'id_number','')}}" v-validate="select_document == 1 ? 'required|numeric|min:8|max:8' : 'required|alpha_num|max:12'" :class="{'input': true, 'is-danger': errors.has('document_number')}"><i v-cloak v-show="errors.has('document_number')" class="fa fa-warning"></i>
                    ...
                    <div class="form-group form-select">
                      ...
                      <select id="district" name="district" v-model="distrito" v-init:distrito="{{array_get($order_detail,'billing_district','')}}" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('district')}">
                    ...
                    <div class="form-group">
                      ...
                      <input id="phone_number" type="text" name="phone_number" v-model="number_phone" v-init:number_phone="{{array_get($order_detail,'billing_phone','')}}" v-validate="'required|numeric|max:11'" maxlength="11" :class="{'input': true, 'is-danger': errors.has('phone_number')}"><i v-cloak v-show="errors.has('phone_number')" class="fa fa-warning"></i>
                    ...
                    <div class="form-group form-select">
                      ...
                      <select id="affiliation" disabled="" style="background-color:#e2e2e2">
                        ...
                        @endforeach
                      @else
                      <select id="affiliation" name="affiliation" v-model="affiliation" v-init:affiliation="{{array_get($order_detail,'affiliation_id','')}}" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('affiliation')}">
                    ...
                    @endif
                      ...
                      <select id="operator" name="operator" v-model="operator" v-init:operator="{{array_get($order_detail,'source_operator_id','')}}" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('operator') }">
                    ...
                    @endif
                      ...
                      <input id="porting_phone" type="text" name="porting_phone" maxlength="11" v-model="porting_phone" v-init:porting_phone="{{array_get($order_detail,'porting_phone','')}}" v-validate="'required|numeric|max:11'" :class="{'input': true, 'is-danger': errors.has('porting_phone')}"><i v-cloak v-show="errors.has('porting_phone')" class="fa fa-warning"></i>
                  ...
                  <div class="section-form">
                    ...
                    <div class="form-group">
                      ...
                      <input id="email" type="text" name="email" v-model="email" v-init:email="{{array_get($order_detail,'contact_email','')}}" v-validate="'required|email|max:150'" maxlength="150" :class="{'input': true, 'is-danger': errors.has('email')}"><i v-cloak v-show="errors.has('email')" class="fa fa-warning"></i>
                    ...
                    <div class="form-group form-select">
                      ...
                      <select id="delivery_district" name="delivery_district" v-model="delivery_district" v-init:email="{{array_get($order_detail,'delivery_district','')}}" v-validate data-vv-rules="required" :class="{'input': true, 'is-danger': errors.has('delivery_district')}">
                        <option value="" selected>Seleccione Distrito</option>
                        @foreach ($distritos as $distrito)
                        <option value="{{$distrito->district_id}}">{{$distrito->district_name}}</option>
                        @endforeach
                    ...
                    <div class="form-group">
                      ...
                      <input id="contact_phone" type="text" name="contact_phone" v-model="number_contact" v-init:number_contact="{{array_get($order_detail,'contact_phone','')}}" v-validate="'required|numeric|max:11'" maxlength="11" :class="{'input': true, 'is-danger': errors.has('contact_phone')}"><i v-cloak v-show="errors.has('contact_phone')" class="fa fa-warning"></i>
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-xs-6 col-sm-3">
                          <label>
                            <input type="radio" name="payment_method" value="1" v-model="mediopago" v-init:mediopago="{{array_get($order_detail,'payment_method_id','')}}" v-validate="'required'"><img src="images/informacioncliente/icon_visa.png" alt="">
                          </label>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                          <label>
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <label>
                            <input type="radio" name="payment_method" checked value="4" v-model="mediopago">
