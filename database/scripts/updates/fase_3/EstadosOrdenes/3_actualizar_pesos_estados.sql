...
UPDATE tbl_order_status SET weight = 2, weight2 = 3 WHERE order_status_name = 'Aceptado';
UPDATE tbl_order_status SET weight = 4, weight2 = 0 WHERE order_status_name = 'En Envío';
